...
<div class="home-grid">
  ...
  <aside class="quick-links-sidebar">
    <h3 class="section-title" style="font-size: 0.8rem; font-weight: 700; letter-spacing: 0.08em; color: #999; text-transform: uppercase; margin-bottom: 1.25rem;">QUICK LINKS</h3>
    <ul class="quick-links" style="list-style: none; padding: 0; margin: 0;">
      <li style="margin-bottom: 0.75rem;">
        <a href="{{ '/about/' | relative_url }}" style="text-decoration: none; color: #555; font-size: 0.85rem; font-weight: 600; display: flex; align-items: center; gap: 0.5rem;">
          <span class="link-icon">👤</span> ABOUT ME
        </a>
      </li>
      <li style="margin-bottom: 0.75rem;">
        <a href="{{ '/projects/' | relative_url }}" style="text-decoration: none; color: #555; font-size: 0.85rem; font-weight: 600; display: flex; align-items: center; gap: 0.5rem;">
          <span class="link-icon">📁</span> ALL PROJECTS
        </a>
      </li>
      <li style="margin-bottom: 0.75rem;">
        <a href="{{ '/blog/' | relative_url }}" style="text-decoration: none; color: #555; font-size: 0.85rem; font-weight: 600; display: flex; align-items: center; gap: 0.5rem;">
          <span class="link-icon">📖</span> JOURNAL
        </a>
      </li>
      <li style="margin-bottom: 0.75rem;">
        <a href="{{ '/resume/' | relative_url }}" style="text-decoration: none; color: #555; font-size: 0.85rem; font-weight: 600; display: flex; align-items: center; gap: 0.5rem;">
          <span class="link-icon">📄</span> RESUME
        </a>
      </li>
      <li style="margin-bottom: 0.75rem;">
        <a href="{{ '/contact/' | relative_url }}" style="text-decoration: none; color: #555; font-size: 0.85rem; font-weight: 600; display: flex; align-items: center; gap: 0.5rem;">
    ...
    {% for post in site.posts limit:3 %}
      <article class="featured-card">
        ...
        <div class="featured-details" style="flex: 1;">
          <h2 class="featured-title" style="font-size: 1.15rem; font-weight: 800; margin: 0 0 0.5rem 0; line-height: 1.3;">
            <a href="{{ post.url | relative_url }}" style="text-decoration: none; color: #111;">{{ post.title }}</a>
          </h2>

          <p class="featured-excerpt" style="font-size: 0.88rem; color: #555; margin-bottom: 0.75rem; line-height: 1.5;">
            {{ post.excerpt | strip_html | truncatewords: 20 }}
          </p>

          <a href="{{ post.url | relative_url }}" class="read-more-link" style="font-size: 0.75rem; font-weight: 700; color: #555; text-decoration: underline; letter-spacing: 0.05em;">READ MORE</a>
        </div>
